...
public class EditarPrueba {
  ...
  public void testEditarPrueba() throws Exception {
    ...
    driver.findElement(By.name("name")).sendKeys("Fulano Editar");
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("fulano.editar@gmail.com");
    ...
    driver.findElement(By.name("name")).click();
    driver.findElement(By.name("name")).clear();
    driver.findElement(By.name("name")).sendKeys("Fulano Prueba de que se Edito");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Woah!'])[1]/following::button[1]")).click();
    driver.findElement(By.xpath("//i")).click();
